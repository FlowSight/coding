...
- details:
   ...
   - In phase 2 for we are implementing the other part of it i.e. gen comment, thats gonna be completed now
    ...
    At phase0(Jan-March2025) we estimated 0-50k license adoption (copilot phase3 collided with this)
    At phase1(April - June) we estimated 100k license adoption, but my changes got 700k
    At phase2(July-Oct) we estimated 300k-500k license adoption, again citing my change we are on track to get 1.8Mil
    At phase4 we estimated 1mil license adoption, future
    This work was Mentioned at state of the mind article by CVP about phase1

...
Mostly to test OOA and understanding around Retry strategy.

Writing up code for default retryer and asked how to make this extensible with customizations
